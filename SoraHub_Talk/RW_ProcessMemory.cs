...
namespace SoraHub_talk
{
    public class RW_Calls
    {
        ...
        public RW_Calls(string procname)
        {
            processName = procname;
            GetProcess(processName); // Optional: Get the process immediately upon object creation
